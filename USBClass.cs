/* PneuView 3 Test Utility v3
 * RMBIMedical  02 Jan 2014
 * Simplified tool for testing PV3 firmware & PCBA using PIC18F4553 MCU
...
namespace PV3TestUtility3
 {
	...
	public class USBClass : Form {
        ...
        public const byte BOOTLOADER_CONNECTED = 2;             // indicates device is connected in bootload mode
        ...
        #region Internal variqables and DLL imports
        // structs ////////////////////////////////////////////////////////////////////////////////////
        ...
        public String deviceID = "Vid_04D8&Pid_FCB6";		// 0x04D8 is Microchip VID; 0xFCB6 is the PV3 PID licensed by MII from Microchip
        //public String deviceID = "Vid_04D8&Pid_003C";		// 0x04D8 is Microchip VID; 0xFCB6 is the PV3 PID licensed by MII from Microchip
        public String blDeviceID = "Vid_04D8&Pid_003C";		// 0x04D8 is Microchip VID; 0x003C is the VID for the Microchip HID Bootloader, modified for use 
                                                            // on the PV3 PCBA
		
		public int connectionState;							// for USB connection state

		public byte[] InBuffer = new byte[65];		        // for data transfer to host, byte 0 => "Report ID", init to zero and never use !!

		public byte[] OutBuffer = new byte[65];		        // for data transfer to device, byte 0 => "Report ID", init to zero and never use !!
        ...
        public SafeFileHandle WriteHandleToUSBDevice = null;
        public SafeFileHandle ReadHandleToUSBDevice = null;
		...
		public USBClass()
		{
			OutBuffer[0] = 0;				// The first byte in the I/O buffers is the "Report ID" and does not get transmitted over the
			InBuffer[0] = 0;				// USB bus, never change these !!!  Start using the buffers for actual data at index 1.
		}
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        public int attemptUSBConnectionToBootloader()
        {
            ...
            String DeviceIDToFind = blDeviceID;
		...
		{
			uint BytesRead = 0;
			ReadFileManagedBuffer(ReadHandleToUSBDevice, InBuffer, 65, ref BytesRead, IntPtr.Zero);		// get buffer from device
		}
		...
		{
			uint BytesWritten = 0;
			WriteFile(WriteHandleToUSBDevice, OutBuffer, 65, ref BytesWritten, IntPtr.Zero);			// send buffer to device
		}
